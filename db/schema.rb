...
ActiveRecord::Schema.define(version: 2023_08_19_054310) do
  ...
  create_table "note_plans", force: :cascade do |t|
    ...
    t.index ["plan_id"], name: "index_note_plans_on_plan_id"
  end
  ...
  create_table "plans", force: :cascade do |t|
    t.integer "customer_id", null: false
    t.string "name", default: "計画", null: false
  ...
  create_table "tags", force: :cascade do |t|
    ...
    t.integer "tag_category", default: 0, null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.integer "customer_id", null: false
  end
  ...
  add_foreign_key "note_plans", "notes"
  add_foreign_key "note_plans", "plans"
